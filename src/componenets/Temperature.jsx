...
function Temperature({ setCity, stats }) {
  ...
  const handleMapClick = () => {
    const encodedCity = encodeURIComponent(stats.location);
    const mapUrl = `https://www.google.com/maps/search/?api=1&query=${encodedCity}`;
...
<>
       <div className="flex align-middle justify-center">
         ...
         />
         <div className="m-4" onClick={handleMapClick}>
           <svg
